public class Declaração { //Declaração da classe DECLARAÇÃO
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("int multiplicacao = 1 * 1;"); // Declara a operação de multiplicação
        System.out.println(multiplicacao); // Declara o valor da variável 'multiplicacao'

        System.out.println("Operador de concatenação de strings: +");
        String concatenacao = "Texto 1 + " + "Texto 2";
        System.out.println("String concatenacao = \"Texto 1 + \" + \"Texto 2\";"); // Concatenação de strings
        System.out.println(concatenacao); // Declara o valor da variável 'concatenacao'
    }
}